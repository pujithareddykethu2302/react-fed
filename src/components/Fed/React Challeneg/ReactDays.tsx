    ...
    return (
        <div className='mt-[20px] h-screen'>
            <div className='flex justify-between mx-[5px]'>
                ...
                <div>
                    <button className='bg-[#563A9C] rounded-[4px] text-white w-[5rem] h-[2.5rem] cursor-pointer mr-[5px]' onClick={()=>{setHeaderUpdate(true)}}>Update</button>
                    <button onClick={()=>{setHeaderUpdate(false)}} className={`${headerUpdate ? "visible" :"hidden"}`}>
